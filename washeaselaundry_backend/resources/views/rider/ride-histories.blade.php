...
@section('title', 'Rider - Ride Histories')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-between">
                <div>
                    <h2 class="title">Ride Histories</h2>
                </div>
                <div class="d-flex align-items-center">
                    <a class="btn btn-primary" href="{{ route('riders.ride-histories.add') }}">
                        <i class="fa-solid fa-user"></i>&nbsp;&nbsp;&nbsp;Add Ride Histories
                    </a>
                </div>
            </div>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="action-button">
                                                        <a href="{{ route('riders.ride-histories.view', 1) }}" title="View">
                                                            <i class="fa-solid fa-eye"></i>
                                                        </a>
                                                    </div>
                                                    <div class="action-button"><a href="{{ route('riders.ride-histories.edit', 1) }}" title="Edit"><i class="fa-solid fa-pencil"></i></a></div>
                                                    <div class="action-button">
