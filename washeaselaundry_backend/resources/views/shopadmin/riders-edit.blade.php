    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{ route("shop_admins.riders.process.edit", $rider->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            @if ($errors->any())
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-10 col-sm-12">
                                    <input type="text" class="form-control" id="first_name" name="first_name" value="{{ $rider->first_name }}"/>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="last_name" class="col-sm-12 col-lg-2 col-form-label">Last name: </label>
                                <div class="col-lg-10 col-sm-12">
                                    <input type="text" class="form-control" id="last_name" name="last_name" value="{{ $rider->last_name }}"/>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="address" class="col-sm-12 col-lg-2 col-form-label">Address: </label>
                                <div class="col-lg-10 col-sm-12">
                                    <input type="text" class="form-control" id="address" name="address" value="{{ $rider->address }}"/>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-lg-10 col-sm-12">
                                    <input type="email" class="form-control" id="email" name="email" value="{{ $rider->email }}"/>
                                </div>
                            </div>
