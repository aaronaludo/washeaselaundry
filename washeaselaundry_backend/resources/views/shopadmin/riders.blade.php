...
@section('title', 'Shop Admin - Riders')
        ...
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <a class="btn btn-primary" href="{{ route('shop_admins.riders.add') }}">
                        <i class="fa-solid fa-user"></i>&nbsp;&nbsp;&nbsp;Add Rider
                    </a>
                </div>
            </div>
            <div class="col-lg-12 mb-20">
                ...
                <div class="box">
                    <div class="row">
                        <div class="col-lg-10">
                        <form action="{{ route("shop_admins.riders.search") }}" method="GET">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="action-button">
                                                            <a href="{{ route('shop_admins.riders.view', $rider->id) }}" title="View">
                                                                <i class="fa-solid fa-eye"></i>
                                                            </a>
                                                        </div>
                                                        <div class="action-button"><a href="{{ route('shop_admins.riders.edit', $rider->id) }}" title="Edit"><i class="fa-solid fa-pencil"></i></a></div>
                                                        <div class="action-button">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{ route("shop_admins.riders.process.delete", $rider->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
