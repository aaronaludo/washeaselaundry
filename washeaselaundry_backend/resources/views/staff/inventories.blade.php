            ...
            <div class="col-lg-12 d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <a class="btn btn-primary" href="{{ route('staffs.inventories.add') }}">
                        <i class="fa-solid fa-user"></i>&nbsp;&nbsp;&nbsp;Add Inventories
                    </a>
                </div>
            </div>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="action-button">
                                                        <a href="{{ route('staffs.inventories.view', 1) }}" title="View">
                                                            <i class="fa-solid fa-eye"></i>
                                                        </a>
                                                    </div>
                                                    <div class="action-button"><a href="{{ route('staffs.inventories.edit', 1) }}" title="Edit"><i class="fa-solid fa-pencil"></i></a></div>
                                                    <div class="action-button">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Are you sure you want to delete inventory 1?
                                                    </div>
