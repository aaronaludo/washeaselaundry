...
@section('title', 'Staff - Transactions')
        ...
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <a class="btn btn-primary" href="{{ route('staffs.transactions.add') }}">
                        <i class="fa-solid fa-user"></i>&nbsp;&nbsp;&nbsp;Add Transactions
                    </a>
                </div>
            </div>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="action-button">
                                                        <a href="{{ route('staffs.transactions.view', 1) }}" title="View">
                                                            <i class="fa-solid fa-eye"></i>
                                                        </a>
                                                    </div>
                                                    <div class="action-button"><a href="{{ route('staffs.transactions.edit', 1) }}" title="Edit"><i class="fa-solid fa-pencil"></i></a></div>
                                                    <div class="action-button">
