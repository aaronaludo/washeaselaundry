...
@section('title', 'Super Admin - Staffs')
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mb-20">
                ...
                <div class="box">
                    <div class="row">
                        <div class="col-lg-10">
                        <form action="{{ route("super_admins.staffs.search") }}" method="GET">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($staffs as $staff)
                                            <tr>
                                                <td>{{ $staff->id }}</td>
                                                <td>{{ $staff->shop_admin->shop_name }}</td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="action-button">
                                                            <a href="{{ route('super_admins.staffs.view', $staff->id) }}" title="View">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{ route("super_admins.staffs.process.delete", $staff->id) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
