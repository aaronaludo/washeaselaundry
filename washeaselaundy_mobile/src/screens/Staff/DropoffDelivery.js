...
const DropoffDelivery = ({ navigation }) => {
  return (
    <ScrollView>
      <Box
        ...
        titleLabel="Add Dropoff and Delivery"
        descriptionLabel="add more riders for the better."
        navigation={navigation}
        buttonContainer={styles.buttonContainer}
        buttonText={styles.buttonText}
        buttonTextLabel={"Add Dropoff and Delivery"}
        buttonNavigation={"Staff Add Dropoff and Delivery"}
      />
...
export default DropoffDelivery;
